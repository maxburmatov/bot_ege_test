...
LEXICON_BUTTON: dict[str, str] = {
    ...
    'admin_bots': '🤖 Меню ботов',
    'all_bots_add_points': 'Добавить всем баллы',
    'bot_edit': 'Управление отдельным ботом',
    'bot_add': 'Добавить бота',
    'bot_add_points': 'Добавить баллы',
    'bot_del_points': 'Снять баллы',
    'bot_change_name': 'Изменить имя',
    'bot_change_avatar': 'Изменить аватар',
